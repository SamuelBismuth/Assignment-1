...
public class LineAlgo1UnitTest {
    ...
    public void getIndexTest() {
        ...
        LineAlgo1 sa = new LineAlgo1(index, macName, ssid, frequency, macNumber , signal, localisation, date);
    ...
    public void getSsidTest() {
        ...
        EarthCoordinate localisation = new EarthCoordinate(34.7,32.6,9.0);
        GregorianCalendar date = new GregorianCalendar(2016,23,45,12,45,01);
        LineAlgo1 sa = new LineAlgo1(index, macName, ssid, frequency, 8, signal, localisation, date);
    ...
    public void getFrequencyTest() {
        ...
        EarthCoordinate localisation = new EarthCoordinate(34.7,32.6,9.0);
        GregorianCalendar date = new GregorianCalendar(2016,23,45,12,45,01);
        LineAlgo1 sa = new LineAlgo1(index, macName, ssid, frequency,7, signal, localisation, date);
