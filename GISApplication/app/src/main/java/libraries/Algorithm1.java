 ...
 * That's why we choose the do a large class which play the role of library for all the formulas of the algorithm 1.
 *
...
public class Algorithm1 {
    ...
    public static double getSumWeightSignal(ArrayList<MacInformation> arrayMacLocation) {
        ...
        for (MacInformation macLocation : arrayMacLocation)
            sumWeigthSignal += macLocation.getWeigthSignal();
        return sumWeigthSignal;
    }
