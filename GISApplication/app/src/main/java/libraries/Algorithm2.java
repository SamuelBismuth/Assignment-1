 ...
 * For example f(x) = 2x + 4 changes the x into 2x + 4, here the methods do the same.
 * That's why we choose the do a large class which play the role of library for all the formulas of the algorithm 2.
...
public class Algorithm2 {
    ...
    /**
     * This method set the relevant number into the object {@link Mac}.
     * What is the relevant number ?
     * The relevant number is a number define by the formula :
    ...
    /**
     * This method calculates the relevant number.
     *
     * @param input
     * @param data
     ...
     * This number replace the weight of the algorithm 1. Recall that weigh = 1 / (signal * signal)
     *
     * @param input
     * @param data
     */
