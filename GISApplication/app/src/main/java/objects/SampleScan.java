 ...
 */
public class SampleScan extends EarthCoordinate implements Serializable {
    ...
    /**
     * toString which is display in the Show Database activity.
     * @return
     */
    @Override
    public String toString() {
        return "Time :" + time.getTime().toString() +
                " Id :" + id +
